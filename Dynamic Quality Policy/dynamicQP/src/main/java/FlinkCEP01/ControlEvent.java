...
public class ControlEvent implements Serializable {
    ...
    public void changeProducer() throws InterruptedException, IOException {
        ...
        //PreviousPet.getP().setStop(true);
        //System.out.println("control event : "+pet.getP().isStop());
        //pet.getP().setLossRate(newLossRate);
        //Controller.producerOffset = 0;
        //System.out.println("LossRate for Producer "+PreviousPet.getP().getID()+" is changed to "+newLossRate);
