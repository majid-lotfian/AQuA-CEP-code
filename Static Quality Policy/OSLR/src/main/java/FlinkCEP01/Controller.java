...
public class Controller {
    ...
    private static void initializeEnvironment() throws IOException {
        ...
        FileInputStream fis=new FileInputStream(new File("/home/majidlotfian/Downloads/lossrate/OSLR/src/main/resources/Temperature.xlsx"));
        ...
        int lineNumber=1;
        Producer p=null;
        List<String> s = Files.readAllLines(Paths.get("/home/majidlotfian/Downloads/lossrate/OSLR/src/main/resources/initialize"));
    ...
    public static void AssignedDataSource(ArrayList<Producer> producerList, ArrayList<Query> queryList) throws InterruptedException {
    ...
    public static void terminateQuery(Query q) throws IOException {
        System.out.println("query "+q.getID()+" is successfully finished !");
    ...
    private static void ExportResults(int[][] globalWindowCounts) throws IOException {
        ...
        FileOutputStream out = new FileOutputStream(
                new File("/home/majidlotfian/Downloads/lossrate/OSLR/src/main/resources/results.xlsx"));
