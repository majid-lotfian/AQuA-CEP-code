...
public class Query implements Serializable {
    ...
    private int previousProducerID=0;

    public int getPreviousProducerID() {
        return previousProducerID;
    }

    public void setPreviousProducerID(int previousProducerID) {
    ...
    int[][] GlobalWindowCounts;

    public int[][] getGlobalWindowCounts() {
        return this.GlobalWindowCounts;
    }
    public int getGlobalWindowCountsByIndex(int index1, int index2) {
        return this.GlobalWindowCounts[index1][index2];
    }

    public void setGlobalWindowCounts(int index1, int index2, int value) {
        this.GlobalWindowCounts[index1][index2] = value;
    }
   ...
   /
    ...
    public void terminateQuery() throws IOException {
        ...
        ExportResults(this.getGlobalWindowCounts());
    ...
    private void ExportResults(int[][] globalWindowCounts) throws IOException {
        ...
        for (int j=0;j<globalWindowCounts.length;j++){
            ...
            cell2.setCellValue(this.getGlobalWindowCountsByIndex(j,0));
            Cell cell3 = row.createCell(2);
            cell3.setCellValue(this.getGlobalWindowCountsByIndex(j,1));
        ...
        if (this.getID().equals("q30")){
            FileOutputStream out = new FileOutputStream(
                    new File("/home/majidlotfian/Downloads/lossrate/multiQuery/AquacepLRMultiQ/src/main/resources/resultsQ1.xlsx"));

            workbook.write(out);
            out.close();
            System.out.println("data for query "+this.getID()+" has been exported");
        } else if (this.getID().equals("q50")){
            FileOutputStream out = new FileOutputStream(
                    new File("/home/majidlotfian/Downloads/lossrate/multiQuery/AquacepLRMultiQ/src/main/resources/resultsQ5.xlsx"));
