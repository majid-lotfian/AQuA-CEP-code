...
public class Controller {
    ...
    private static void initializeEnvironment() throws IOException {
        ...
        FileInputStream fis=new FileInputStream(new File("/home/majidlotfian/Downloads/lossrate/multiQuery/AquacepLRMultiQ/src/main/resources/Temperature.xlsx"));
        ...
        int lineNumber=1;
        Producer p=null;
        List<String> s = Files.readAllLines(Paths.get("/home/majidlotfian/Downloads/lossrate/multiQuery/AquacepLRMultiQ/src/main/resources/initialize"));
        ...
        if (solutionSpace.size()>0) {
            ...
            for (Query q : Controller.queryList) {
                for (SE se : q.getEtList()) {
                    ...
                    if (Integer.parseInt(pet.getP().getID())!=pet.getQ().getPreviousProducerID()){
                    ...
                    pet.getQ().setPreviousProducerID(Integer.parseInt(pet.getP().getID()));
