                    ...
                    .process(new ProcessAllWindowFunction<DataEvent, String, TimeWindow>() {
                        ...
                        public void process(Context context, Iterable<DataEvent> input,
                            ...
                            if (Controller.queryOffset < query.getDuration()) {
                                ...
                                Controller.GlobalWindowCounts[Controller.queryOffset][1]=Integer.parseInt(Controller.currentPET.getP().getID());
                                ...
                                if ( Controller.producerOffset> window_size-1){
                                    ...
                                    //System.out.println("threshold is :"+(1-(localPET.getP().getLossRate()/100))*window_size);

                                    if (count < (1-(Controller.currentProducerLossRate/100))*window_size){
                                        /*
                                    ...
                                    if (Controller.averaging){
                                        ...
                                        //System.out.println("count is : "+count);
                                                ...
                                                double newLossRate = (1.0- ((double) count / Controller.windowSize))*100;
                                                //System.out.println("window size is : "+Controller.windowSize + " and new loss rate is : "+newLossRate);
